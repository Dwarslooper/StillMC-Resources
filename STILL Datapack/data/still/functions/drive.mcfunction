...
execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s as @p[distance=..0.5] at @s if data entity @s {Inventory:[{Slot:2b}]} unless data entity @s {Inventory:[{id:"minecraft:lime_dye",Slot:2b}]} run teleport @s ~ ~0.1 ~
execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s as @p[distance=..0.5] at @s if data entity @s {Inventory:[{Slot:3b}]} unless data entity @s {Inventory:[{id:"minecraft:lime_dye",Slot:3b}]} run teleport @s ~ ~0.1 ~
execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s as @p[distance=..0.5] at @s if data entity @s {Inventory:[{Slot:4b}]} unless data entity @s {Inventory:[{id:"minecraft:red_dye",Slot:4b}]} run teleport @s ~ ~0.1 ~
execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s as @p[distance=..0.5] at @s if data entity @s {Inventory:[{Slot:5b}]} unless data entity @s {Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:5b}]} run teleport @s ~ ~0.1 ~
execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s as @p[distance=..0.5] at @s if data entity @s {Inventory:[{Slot:6b}]} unless data entity @s {Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:6b}]} run teleport @s ~ ~0.1 ~


execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s as @p[distance=..0.5] at @s if data entity @s {Inventory:[{Slot:2b}]} unless data entity @s {Inventory:[{id:"minecraft:lime_dye",Slot:2b}]} run title @s actionbar {"text":"Achtung! Für dieses Fahrzeug werden die Inventarslots 3,4,5,6 und 7 benötigt","color":"gold"}
execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s as @p[distance=..0.5] at @s if data entity @s {Inventory:[{Slot:3b}]} unless data entity @s {Inventory:[{id:"minecraft:lime_dye",Slot:3b}]} run title @s actionbar {"text":"Achtung! Für dieses Fahrzeug werden die Inventarslots 3,4,5,6 und 7 benötigt","color":"gold"}
execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s as @p[distance=..0.5] at @s if data entity @s {Inventory:[{Slot:4b}]} unless data entity @s {Inventory:[{id:"minecraft:red_dye",Slot:4b}]} run title @s actionbar {"text":"Achtung! Für dieses Fahrzeug werden die Inventarslots 3,4,5,6 und 7 benötigt","color":"gold"}
execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s as @p[distance=..0.5] at @s if data entity @s {Inventory:[{Slot:5b}]} unless data entity @s {Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:5b}]} run title @s actionbar {"text":"Achtung! Für dieses Fahrzeug werden die Inventarslots 3,4,5,6 und 7 benötigt","color":"gold"}
execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s as @p[distance=..0.5] at @s if data entity @s {Inventory:[{Slot:6b}]} unless data entity @s {Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:6b}]} run title @s actionbar {"text":"Achtung! Für dieses Fahrzeug werden die Inventarslots 3,4,5,6 und 7 benötigt","color":"gold"}


execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s run replaceitem entity @p[distance=..0.5,nbt=!{Inventory:[{Slot:2b}]},nbt=!{Inventory:[{Slot:2b,id:"minecraft:lime_dye"}]}] hotbar.2 lime_dye{display:{Name:'{"text":"Vorwärts","color":"green","italic":false}'}} 1
...
execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s run replaceitem entity @p[distance=..0.5,nbt=!{Inventory:[{Slot:3b}]},nbt=!{Inventory:[{Slot:3b,id:"minecraft:lime_dye"}]}] hotbar.3 lime_dye{display:{Name:'{"text":"Vorwärts x2","color":"green","italic":false}'}} 1
...
execute as @e[type=armor_stand,tag=STILL_engine] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s run replaceitem entity @p[distance=..0.5,nbt=!{Inventory:[{Slot:4b}]},nbt=!{Inventory:[{Slot:4b,id:"minecraft:lime_dye"}]}] hotbar.4 red_dye{display:{Name:'{"text":"Rückwärts","color":"red","italic":false}'}} 1
...
execute as @e[type=armor_stand,tag=STILL_engine,scores={still.warn=1}] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s run replaceitem entity @p[distance=..0.5,nbt={Inventory:[{Slot:5b,id:"minecraft:carrot_on_a_stick"}]}] hotbar.5 carrot_on_a_stick{CustomModelData:999,display:{Name:'{"text":"Warnleuchte on/off","color":"green","italic":false}'}} 1
execute as @e[type=armor_stand,tag=STILL_engine] at @s unless score @s still.warn matches 1 as @e[type=minecart,tag=STILL_seat,distance=..2] at @s run replaceitem entity @p[distance=..0.5,nbt={Inventory:[{Slot:5b,id:"minecraft:carrot_on_a_stick"}]}] hotbar.5 carrot_on_a_stick{CustomModelData:999,display:{Name:'{"text":"Warnleuchte on/off","color":"red","italic":false}'}} 1
execute as @e[type=armor_stand,tag=STILL_engine,scores={still.warn=1}] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s run replaceitem entity @p[distance=..0.5,nbt=!{Inventory:[{Slot:5b}]}] hotbar.5 carrot_on_a_stick{CustomModelData:999,display:{Name:'{"text":"Warnleuchte on/off","color":"green","italic":false}'}} 1
execute as @e[type=armor_stand,tag=STILL_engine] at @s unless score @s still.warn matches 1 as @e[type=minecart,tag=STILL_seat,distance=..2] at @s run replaceitem entity @p[distance=..0.5,nbt=!{Inventory:[{Slot:5b}]}] hotbar.5 carrot_on_a_stick{CustomModelData:999,display:{Name:'{"text":"Warnleuchte on/off","color":"red","italic":false}'}} 1
...
execute as @e[type=armor_stand,tag=STILL_engine,scores={still.ankp=1}] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s run replaceitem entity @p[distance=..0.5,nbt={Inventory:[{Slot:6b,id:"minecraft:carrot_on_a_stick"}]}] hotbar.6 carrot_on_a_stick{CustomModelData:1000,display:{Name:'{"text":"Anhänger: on/off","color":"green","italic":false}'}} 1
execute as @e[type=armor_stand,tag=STILL_engine] at @s unless score @s still.ankp matches 1 as @e[type=minecart,tag=STILL_seat,distance=..2] at @s run replaceitem entity @p[distance=..0.5,nbt={Inventory:[{Slot:6b,id:"minecraft:carrot_on_a_stick"}]}] hotbar.6 carrot_on_a_stick{CustomModelData:1001,display:{Name:'{"text":"Anhänger: on/off","color":"red","italic":false}'}} 1
execute as @e[type=armor_stand,tag=STILL_engine,scores={still.ankp=1}] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] at @s run replaceitem entity @p[distance=..0.5,nbt=!{Inventory:[{Slot:6b}]}] hotbar.6 carrot_on_a_stick{CustomModelData:1000,display:{Name:'{"text":"Anhänger: on/off","color":"green","italic":false}'}} 1
execute as @e[type=armor_stand,tag=STILL_engine] at @s unless score @s still.ankp matches 1 as @e[type=minecart,tag=STILL_seat,distance=..2] at @s run replaceitem entity @p[distance=..0.5,nbt=!{Inventory:[{Slot:6b}]}] hotbar.6 carrot_on_a_stick{CustomModelData:1001,display:{Name:'{"text":"Anhänger: on/off","color":"red","italic":false}'}} 1
...
execute as @e[type=minecraft:armor_stand,tag=STILL_anhaenger] at @s facing entity @e[type=minecraft:area_effect_cloud,tag=still.ah_rout_front,tag=still.ah_rout,distance=..4,sort=nearest,limit=1] eyes unless entity @e[tag=STILL_engine,distance=..2.2] unless entity @e[tag=STILL_anhaenger,distance=0.1..3.2] unless entity @e[tag=STILL_anhaenger1,distance=0.1..3.2] unless entity @e[tag=STILL_HWengine,tag=!STILL_HWfloat,distance=0.1..3.2] run teleport @s ^ ^ ^0.6
...
execute as @e[tag=STILL_anhaenger1,type=minecraft:armor_stand] at @s as @e[type=minecart,tag=STILL_seat,distance=..2] store result entity @s Rotation[0] float 1 run scoreboard players get @e[tag=STILL_anhaenger1,type=minecraft:armor_stand,sort=nearest,distance=..2,limit=1] still.data
...
execute as @e[type=minecraft:armor_stand,tag=STILL_anhaenger1] at @s facing entity @e[type=minecraft:area_effect_cloud,tag=still.ah_rout_back,tag=still.ah_rout,distance=..4,sort=nearest,limit=1] eyes unless entity @e[tag=STILL_engine,distance=..3.2] unless entity @e[tag=STILL_anhaenger1,distance=0.1..3.2] unless entity @e[tag=STILL_anhaenger,distance=0.1..3.2] unless entity @e[tag=STILL_HWengine,tag=!STILL_HWfloat,distance=0.1..3.2] run teleport @s ^ ^ ^0.6
...
execute as @e[type=minecraft:armor_stand,tag=STILL_anhaenger1] at @s facing entity @e[type=minecraft:area_effect_cloud,tag=still.ah_rout_front,tag=still.ah_rout,distance=..4,sort=nearest,limit=1] eyes unless entity @e[tag=STILL_engine,distance=..2.2] unless entity @e[tag=STILL_anhaenger1,distance=0.1..3.2] unless entity @e[tag=STILL_anhaenger,distance=0.1..3.2] unless entity @e[tag=STILL_HWengine,tag=!STILL_HWfloat,distance=0.1..3.2] run teleport @s ^ ^ ^0.6
execute as @e[tag=STILL_anhaenger] at @s run data modify entity @s Rotation[0] set value 0



execute as @e[type=minecraft:armor_stand,tag=STILL_HWengine,tag=!STILL_HWfloat] at @s run teleport @s ~ ~ ~ facing entity @e[type=area_effect_cloud,limit=1,tag=still.ah_rout,tag=still.ah_rout_back,distance=..4,sort=nearest] eyes
execute as @e[type=minecraft:armor_stand,tag=STILL_HWengine,tag=!STILL_HWfloat] at @s facing entity @e[type=minecraft:area_effect_cloud,tag=still.ah_rout_back,tag=still.ah_rout,distance=..4,sort=nearest,limit=1] eyes unless entity @e[tag=STILL_engine,distance=..3.2] unless entity @e[tag=STILL_HWengine,tag=!STILL_HWfloat,distance=0.1..3.2] unless entity @e[tag=STILL_anhaenger,distance=0.1..3.2] unless entity @e[tag=STILL_anhaenger1,distance=0.1..3.2] run teleport @s ^ ^ ^0.6
execute as @e[type=minecraft:armor_stand,tag=STILL_HWengine,tag=!STILL_HWfloat] at @s run teleport @s ~ ~ ~ facing entity @e[type=area_effect_cloud,limit=1,tag=still.ah_rout_front,tag=still.ah_rout,distance=..4,sort=nearest] eyes
execute as @e[type=minecraft:armor_stand,tag=STILL_HWengine,tag=!STILL_HWfloat] at @s facing entity @e[type=minecraft:area_effect_cloud,tag=still.ah_rout_front,tag=still.ah_rout,distance=..4,sort=nearest,limit=1] eyes unless entity @e[tag=STILL_engine,distance=..2.2] unless entity @e[tag=STILL_HWengine,tag=!STILL_HWfloat,distance=0.1..3.2] unless entity @e[tag=STILL_anhaenger,distance=0.1..3.2] unless entity @e[tag=STILL_anhaenger1,distance=0.1..3.2] run teleport @s ^ ^ ^0.6
execute as @e[tag=STILL_anhaenger] at @s run data modify entity @s Rotation[0] set value 0
